...
--        apex_application_install.set_application_alias('MY-APP');
--
...
,p_list_item_link_target=>'logout'
...
,p_static_id=>'home'
,p_list_item_link_target=>'f?p=200:1:0::NO'
...
':P9999_REMEMBER := case when :P9999_USERNAME is not null then ''Y''
