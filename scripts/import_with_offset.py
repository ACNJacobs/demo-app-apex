...
# Use a large id_offset to generate unique IDs
# The original SCAFF APP used offset 0, so IDs like 7207163271888401
# We'll use offset 10000000000000000 to shift all IDs
...
print("Executing import with ID offset...")
